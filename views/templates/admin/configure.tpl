...
<div class="panel">
	...
	<p>
		<strong>{l s='Here is my new generic module!' mod='dropdownsearch'}</strong><br />
		{l s='Thanks to PrestaShop, now I have a great module.' mod='dropdownsearch'}<br />
		{l s='I can configure it using the following configuration form.' mod='dropdownsearch'}
	</p>
	<br />
	<p>
